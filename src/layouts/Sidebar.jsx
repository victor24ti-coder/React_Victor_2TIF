    ...
    return (
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-logo" className="flex flex-col">
                <span id="logo-title" className="font-poppins-bold text-[48px] text-gray-900">
            ...
            <div id="sidebar-menu" className="mt-10">
                <ul id="menu-list" className="space-y-3">
                    ...
                    <li>
                      ...
                      <li>
	                    <Link id="menu-4" to="/product" className="hover:text-hijau flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:font-extrabold">
                            <BsPeople className="mr-4 text-xl"/>
                            Products</Link>
	                  </li>
                </ul>
            ...
            <div id="sidebar-footer" className="mt-auto">
                <div id="footer-card" className="bg-hijau px-4 py-2 rounded-md shadow-lg mb-10 flex items-center">
                    ...
                    <img id="footer-avatar" src="https://img.freepik.com/vektor-premium/seorang-koki-kartun-dengan-sendok-kayu-dan-tanda-yang-bertuliskan-koki_1185634-1894.jpg" className="w-20 rounded-full"/>
                </div>
